...
const makeOne = () => {
	const num1 = 5;
	const num2 = 10;
    return resultOne.innerHTML = (num1 + num2);
};
...
const makeEleven = () => {
	//Не совсем понятны условия: операция 5? модуль 2????
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	resultSixteen.innerHTML = str.slice(3);
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	resultSeventeen.innerHTML = str.slice(3,7);
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	resultNineteen.innerHTML = str.slice(7, str.length)
};
...
const makeTwenty = (a,b) => {
	let arr = [10, 25, 5, 30, 15];
	return resultTwenty.innerHTML = Math.max.apply(null,arr)
};
...
const makeTwentyOne = () => {
	resultTwentyOne.innerHTML = Math.round(Math.random() * 10)
};
...
const makeTwentyTwo = () => {
	let arr = [10, 25, 5, 30, 15,];
	resultTwentyTwo.innerHTML = Math.min.apply(null,arr);
};
...
const makeTwentyFour = () => {
	let arr = [7, 3, 11, 5, 9,];
	resultTwentyFour.innerHTML = Math.min.apply(null,arr)
};
...
const makeTwentyFive = () => {
	let arr = [7, 3, 11, 5, 9,];
	resultTwentyFive.innerHTML = Math.max.apply(null,arr);
};
...
const makeTwentySeven = () => {
	resultTwentySeven.innerHTML = Math.floor(Math.random() * (100 - 50 + 1) + 50)
};
